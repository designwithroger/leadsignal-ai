...
export const dictionary = {
  en: {
    ...
    search: {
      ...
      cardDescription: "Choose the market, offer, language, and tone LeadSignal AI should use for this analysis.",
      niche: "Niche",
      ...
      draftSaved: "Draft saved in this form. Run the analysis when you are ready.",
      starting: "Analyzing leads...",
      formError: "Please check the form and try again.",
      requiredField: "This field is required.",
      quantityMinError: "Quantity must be at least 1.",
      quantityMaxError: "Quantity is capped at 25 for this MVP.",
      quantityCreditError: "You do not have enough credits for that quantity.",
      offers: {
      ...
      previewDescription: "LeadSignal will use your search details to build and analyze a focused local lead list.",
      previewCredits: "1 credit = 1 analyzed business.",
      previewFind: "Search will find local businesses that match your niche and city.",
      previewSignals: "Analysis will detect marketing signals like CTAs, forms, tracking, schema, and booking links.",
      previewOpeners: "Openers will be generated after analysis using the selected offer, language, and tone.",
      previewTip: "Start with a smaller quantity when testing a new niche, then scale once the signal quality looks right.",
  ...
  es: {
    ...
    search: {
      ...
      cardDescription: "Elige el mercado, la oferta, el idioma y el tono que LeadSignal AI debe usar para este an\u00e1lisis.",
      niche: "Nicho",
      ...
      draftSaved: "Borrador guardado en este formulario. Ejecuta el an\u00e1lisis cuando est\u00e9s listo.",
      starting: "Analizando leads...",
      formError: "Revisa el formulario e int\u00e9ntalo de nuevo.",
      requiredField: "Este campo es obligatorio.",
      quantityMinError: "La cantidad debe ser al menos 1.",
      quantityMaxError: "La cantidad est\u00e1 limitada a 25 en este MVP.",
      quantityCreditError: "No tienes suficientes cr\u00e9ditos para esa cantidad.",
      offers: {
        website_redesign: "Redise\u00f1o web",
        seo: "SEO",
        google_ads: "Google Ads",
        meta_ads: "Meta Ads",
        branding: "Branding",
      ...
      previewTitle: "Qu\u00e9 pasa despu\u00e9s",
      previewDescription: "LeadSignal usar\u00e1 los detalles de tu b\u00fasqueda para crear y analizar una lista enfocada de leads locales.",
      previewCredits: "1 cr\u00e9dito = 1 negocio analizado.",
      previewFind: "La b\u00fasqueda encontrar\u00e1 negocios locales que coincidan con tu nicho y ciudad.",
      previewSignals: "El an\u00e1lisis detectar\u00e1 se\u00f1ales de marketing como CTAs, formularios, tracking, schema y links de reserva.",
      previewOpeners: "Las aperturas se generar\u00e1n despu\u00e9s del an\u00e1lisis usando la oferta, idioma y tono seleccionados.",
      previewTip: "Empieza con una cantidad peque\u00f1a al probar un nicho nuevo y escala cuando la calidad de las se\u00f1ales se vea bien.",
